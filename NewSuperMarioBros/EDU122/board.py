...
class Board:
    ...
    def draw(self):
        ...
        if self.player.lives > 0 and self.player.x < 2000 and self.player2.lives > 0 and self.player2.x < 2000:
            ...
            pyxel.text(140, 40, 'Score2: ' + str(self.player2.score), 0)
            pyxel.text(1, 21, 'X2 coordinate: ' + str(self.player2.x), 0)
            pyxel.text(1, 31, 'Y2 coordinate: ' + str(self.player2.y), 0)
        ...
        elif self.player.x > 2000 or self.player2.x > 2000:
            pyxel.cls(0)
