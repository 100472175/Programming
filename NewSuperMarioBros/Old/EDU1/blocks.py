...
class Blocks:
    ...
    def __init__(self):
        ...
        self.question_block_list = [QuestionBlocks(29 * 8, 23 * 8, "coins"), QuestionBlocks(44 * 8, 15 * 8, "coins"),
                                    QuestionBlocks(42 * 8, 23 * 8, 'mushroom'),
                                    QuestionBlocks(46 * 8, 23 * 8), QuestionBlocks(47 * 8, 23 * 8),
                                    QuestionBlocks(86 * 8, 23 * 8), QuestionBlocks(87 * 8, 23 * 8),
                                    QuestionBlocks(90 * 8, 23 * 8),
                                    QuestionBlocks(114 * 8, 23 * 8), QuestionBlocks(115 * 8, 23 * 8),
                                    QuestionBlocks(162 * 8, 23 * 8, 'mushroom'), QuestionBlocks(163 * 8, 23 * 8),
                                    QuestionBlocks(202 * 8, 15 * 8), QuestionBlocks(203 * 8, 15 * 8),
                                    QuestionBlocks(221 * 8, 23 * 8), QuestionBlocks(222 * 8, 23 * 8),
                                    QuestionBlocks(227 * 8, 23 * 8), QuestionBlocks(228 * 8, 23 * 8),
                                    QuestionBlocks(221 * 8, 15 * 8), QuestionBlocks(222 * 8, 15 * 8),
                                    QuestionBlocks(29 * 8, 23 * 8), QuestionBlocks(30 * 8, 23 * 8),
                                    QuestionBlocks(44 * 8, 15 * 8), QuestionBlocks(45 * 8, 15 * 8),
                                    QuestionBlocks(202 * 8, 23 * 8), QuestionBlocks(202 * 8, 23 * 8),
                                    QuestionBlocks(221 * 8, 15 * 8), QuestionBlocks(222 * 8, 15 * 8),
                                    QuestionBlocks(221 * 8, 23 * 8), QuestionBlocks(222 * 8, 23 * 8),
                                    QuestionBlocks(227 * 8, 23 * 8), QuestionBlocks(228 * 8, 23 * 8),
                                    QuestionBlocks(236 * 8, 29 * 8), QuestionBlocks(237 * 8, 29 * 8),
                                    QuestionBlocks(238 * 8, 27 * 8), QuestionBlocks(239 * 8, 27 * 8),
                                    QuestionBlocks(240 * 8, 25 * 8), QuestionBlocks(241 * 8, 25 * 8),
                                    QuestionBlocks(90 * 8, 23 * 8), QuestionBlocks(91 * 8, 23 * 8),
                                    QuestionBlocks(114 * 8, 23 * 8), QuestionBlocks(115 * 8, 23 * 8)]
